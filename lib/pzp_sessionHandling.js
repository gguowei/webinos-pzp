...
function Pzp(inputConfig) {
    ...
    function virginPzpInitialization(){
        ...
        // Insert a progress broadcast point to push forward Android progress
        // bar.
        if (process.platform == 'android') {
            try {
                // Call interface to webinos-android
                require('bridge').load(require("../platform_interfaces.json")
                    .android
                    .PZPNotificationManagerImpl, exports)
                    .eventNotify("progress", function(status){
